...
export function Home() {
  ...
  return (
    <div className="bg-white">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-md bg-gradient-to-r from-white/10 to-sky-500/10 border-b border-sky-200/30 shadow-lg">
        <div className="container py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link to="/events" className="text-gray-700 hover:text-sky-600 font-medium transition">
              Events
            </Link>
            ...
            <a href="#" className="text-gray-700 hover:text-sky-600 font-medium transition">
              About
            </a>
          </div>
      ...
      <section className="section container relative min-h-screen flex items-center">
        <div className="absolute top-0 left-0 w-96 h-96 bg-cyan-400 rounded-full blur-3xl opacity-20 -ml-48 -mt-48"></div>
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-emerald-400 rounded-full blur-3xl opacity-15 -mr-40 -mb-40"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10">
          ...
          <div className="hidden lg:block relative">
            ...
            <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&h=500&fit=crop" alt="Event Feedback Platform"
              className="rounded-lg shadow-2xl relative z-10 hover:shadow-cyan-500/50 transition-all duration-300 border-2 border-sky-200/50"
            />
          </div>
        </div>
      </section>
      ...
      <section className="section section-bg container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat) => (
            <div key={stat.label} className="card p-6 text-center bg-gradient-to-br from-sky-500/10 to-cyan-500/10 border-2 border-sky-200/50">
              <div className="text-3xl font-bold bg-gradient-to-r from-sky-600 to-cyan-500 bg-clip-text text-transparent mb-2">{stat.value}</div>
      ...
      <section className="section container">
            ...
            <article key={event.id} className="card overflow-hidden">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex items-center gap-1 bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent ml-2">
        ...
        <div className="text-center">
          <Link to="/events" className="btn btn-secondary inline-flex items-center gap-2 bg-white border-2 border-sky-500 text-sky-600 font-semibold px-6 py-3 rounded-lg hover:bg-sky-50 transition"> View All Events
      ...
      <section className="section section-bg container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, idx) => {
            ...
            return (
              <div key={idx} className="card p-8 text-center bg-gradient-to-br from-sky-500/10 to-cyan-500/10 border-2 border-sky-200/50 hover:border-cyan-400 transition">
                <div className="flex justify-center mb-4">
                  <Icon className="text-4xl bg-gradient-to-r from-sky-500 to-cyan-500 bg-clip-text text-transparent" />
                </div>
      ...
      {/* CTA Section */}
      <section className="section bg-gradient-to-r from-sky-600 via-cyan-500 to-emerald-600 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-sky-400 rounded-full blur-3xl opacity-10 -mr-32 -mt-32"></div>
        ...
        <div className="container text-center text-white relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/events"
              className="btn bg-white text-sky-600 hover:bg-sky-50 font-semibold hover:shadow-xl px-6 py-3 rounded-lg transition"
            >
              Get Started
            </Link>
            <a href="#" className="btn border-2 border-white text-white hover:bg-white hover:bg-opacity-10 hover:shadow-lg transition-all px-6 py-3 rounded-lg"
            > Learn More </a>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-slate-950 via-sky-950 to-slate-950 text-white py-12 relative overflow-hidden">
        <div className="container relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <div>
              <h4 className="font-bold text-lg mb-4 text-sky-300">Product</h4>
            ...
            <div>
              <h4 className="font-bold text-lg mb-4 text-sky-300">Company</h4>
              <ul className="space-y-2">
            ...
            <div>
              <h4 className="font-bold text-lg mb-4 text-sky-300">Legal</h4>
              <ul className="space-y-2">
            ...
            <div>
              <h4 className="font-bold text-lg mb-4 text-sky-300">Follow Us</h4>
              <ul className="space-y-2">
                <li><a href="#twitter" className="hover:text-cyan-400 transition-colors">Twitter</a></li>
                <li><a href="#linkedin" className="hover:text-cyan-400 transition-colors">LinkedIn</a></li>
                <li><a href="#facebook" className="hover:text-cyan-400 transition-colors">Facebook</a></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-sky-900 pt-8 text-center text-gray-400">
